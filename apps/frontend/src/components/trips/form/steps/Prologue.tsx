...
export default function Prologue() {
  return (
    <div className="flex flex-col md:flex-row mx-6 md:mx-10 gap-8 h-full py-4">
      <div className="flex flex-col w-full md:w-1/2 gap-4 h-full">
        ...
        <div className="flex flex-col gap-1 flex-1 min-h-0">
          ...
          <Textarea className="max-w-[32rem] flex-1 min-h-[150px] resize-none" />
        </div>
      </div>
      <div className="flex flex-col w-full md:w-1/2 gap-1 h-full">
        <Label className="text-base flex-shrink-0">
