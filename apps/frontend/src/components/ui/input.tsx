    ...
    return (
      <div className="relative flex items-center w-full">
        ...
        <input
          ...
          data-slot="input"
          className={cn(
            'file:text-foreground max-w-[32rem] pl-4 placeholder:text-foreground/30 selection:bg-primary selection:text-primary-foreground dark:bg-input/30 flex h-15 w-full min-w-0 rounded-xl border border-accent bg-muted text-sm md:text-lg shadow-xs mt-1 transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-85 disabled:text-foreground/30',
