    ...
    return (
      <div className="relative flex items-center w-full max-w-[32rem]">
        ...
        <input
          ...
          data-slot="input"
          className={cn(
            "file:text-foreground max-w-[32rem] placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input flex h-13 w-full min-w-0 rounded-xl border-3 bg-muted px-3 py-1 text-sm md:text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
